...
You can read more about the skin [here](Overview.md). Also, Evelution uses the ``main`` branch that it is compatible with both MediaWiki 1.36 and MediaWiki 1.37
