...
# Requirements
To Run Evelution on your wiki, you must have MediaWiki 1.36 or later. Older versions are not supported. The ``main`` branch is used for both 1.36 and 1.37 releases of MediaWiki
