...
';\n' +
				...
				// Body BG Settings
				 ...
				 '--canvas-tabs-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--canvas-tabs-background-color")  + ';\n' +
				 '--canvas-tabs-opacity:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--canvas-tabs-opacity")  + ';\n' +
				 '--canvas-active-tabs-opacity:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--canvas-active-tabs-opacity")  + ';\n' +
				 // 2nd Page Color
				 ...
				 '--hyperlink-tabs-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--hyperlink-tabs-background-color")  + ';\n' +
				 '--hyperlink-tabs-opacity:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--hyperlink-tabs-opacity")  + ';\n' +
				 '--hyperlink-active-tabs-opacity:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--hyperlink-active-tabs-opacity")  + ';\n' +
				 ...
				 '--active-title-tabs-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--active-title-tabs-background-color")  + ';\n' +
				 '--active-title-tabs-opacity:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--active-title-tabs-opacity")  + ';\n' +
				 '--active-title-active-tabs-opacity:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--active-title-active-tabs-opacity")  + ';\n' +
				 ...
				 '--inactive-title-tabs-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--inactive-title-tabs-background-color")  + ';\n' +
				 '--inactive-title-tabs-opacity:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--inactive-title-tabs-opacity")  + ';\n' +
				 '--inactive-title-active-tabs-opacity:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--inactive-title-active-tabs-opacity")  + ';\n' +
				 // Alert
				 ...
				 // Graph
				 '--cpu-graph-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--cpu-graph-background-color")  + ';\n' +
				 '--cpu-graph-background-color-hover:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--cpu-graph-background-color-hover")  + ';\n' +
				 '--ram-graph-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--ram-graph-background-color")  + ';\n' +
				 '--ram-graph-background-color-hover:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--ram-graph-background-color-hover")  + ';\n' +
				 '--disk-graph-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--disk-graph-background-color")  + ';\n' +
				 '--disk-graph-background-color-hover:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--disk-graph-background-color-hover")  + ';\n' +
				 '--network-graph-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--network-graph-background-color")  + ';\n' +
				 '--network-graph-background-color-hover:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--network-graph-background-color-hover")  + ';\n' +
				 '--gpu-graph-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--gpu-graph-background-color")  + ';\n' +
				 '--gpu-graph-background-color-hover:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--gpu-graph-background-color-hover")  + ';\n' +
				 '--npu-graph-background-color:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--npu-graph-background-color")  + ';\n' +
				 '--npu-graph-background-color-hover:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--npu-graph-background-color-hover")  + ';\n' +
				 // Graph RGB
				 '--cpu-graph-background-color-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--cpu-graph-background-color-rgb")  + ';\n' +
				 '--cpu-graph-background-color-hover-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--cpu-graph-background-color-hover-rgb")  + ';\n' +
				 '--ram-graph-background-color-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--ram-graph-background-color-rgb")  + ';\n' +
				 '--ram-graph-background-color-hover-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--ram-graph-background-color-hover-rgb")  + ';\n' +
				 '--disk-graph-background-color-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--disk-graph-background-color-rgb")  + ';\n' +
				 '--disk-graph-background-color-hover-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--disk-graph-background-color-hover-rgb")  + ';\n' +
				 '--network-graph-background-color-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--network-graph-background-color-rgb")  + ';\n' +
				 '--network-graph-background-color-hover-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--network-graph-background-color-hover-rgb")  + ';\n' +
				 '--gpu-graph-background-color-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--gpu-graph-background-color-rgb")  + ';\n' +
				 '--gpu-graph-background-color-hover-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--gpu-graph-background-color-hover-rgb")  + ';\n' +
				 '--npu-graph-background-color-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--npu-graph-background-color-rgb")  + ';\n' +
				 '--npu-graph-background-color-hover-rgb:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--npu-graph-background-color-hover-rgb")  + ';\n' +
				 // Font
				 ...
				 // Icon Style
				 '--system-icon-style:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--system-icon-style")  + ';\n' +
				 '--system-icon-font-family:' + getComputedStyle(document.querySelector('body')).getPropertyValue("--system-icon-font-family")  + ';\n' +
				 // Misc
