	...
	$("#mw-content-text").append(
		...
		// Body Background Color
			...
			// Default Crayola Colors (169)
				...
				'<option value="#0c0c0c">' +
			'</datalist>' +
			'<datalist id="td_fonts2">' + // Sans Serif Fonts (40)
				'<option value=\'"Alef"\'>' +
			...
			'<datalist id="td_fonts4">' + // Serif Fonts (34)
				...
				'<option value=\'"BioRhyme Expanded"\'>' + 
				'<option value=\'"Brileback Xtreme"\'>' + // Custom
				'<option value=\'"Cambo"\'>' +
				'<option value=\'"Cutive"\'>' +
				'<option value=\'"David Libre"\'>' +
				'<option value=\'"Gentium Plus"\'>' +
				...
				'<option value=\'"Noto Serif Hong Kong"\'>' +
				'<option value=\'"Noto Serif Japanese"\'>' +
				'<option value=\'"Noto Serif Simplified Chinese"\'>' +
				'<option value=\'"Noto Serif Traditional Chinese"\'>' +
				'<option value=\'"PT Serif"\'>' +
				'<option value=\'"Pridi"\'>' +
				'<option value=\'"Ramaraja"\'>' +
				'<option value=\'"Roboto Serif"\'>' + 
				'<option value=\'"Roboto Slab"\'>' +
				'<option value=\'"Song Myung"\'>' +
			...
			'<datalist id="td_fonts">' + // Rounded Fonts (27)
				...
				'<option value=\'"Baloo Chettan 2"\'>' +
				'<option value=\'"Baloo Da 2"\'>' +
				'<option value=\'"Baloo Tamma 2"\'>' +
				'<option value=\'"Chango"\'>' + 
				...
				'<option value=\'"Pavanam"\'>' +
				'<option value=\'"Quicksand"\'>' + 
				'<option value=\'"Raleway"\'>' +
				'<option value=\'"Rubik"\'>' +
				'<option value=\'"Style Script"\'>' + 
			...
			'<datalist id="td_fonts3">' + // Monospace Fonts (16)
				...
				'<option value=\'"M PLUS 1 Code"\'>' + 
				'<option value=\'"M PLUS Code Latin"\'>' + 
